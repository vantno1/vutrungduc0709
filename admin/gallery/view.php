...
<body>
  ...
  <!-- Hiển thị bảng và xử lý tìm kiếm -->
  <table class="table_form">
    ...
    $searchQuery = "SELECT * FROM gallery WHERE name LIKE '%$searchTerm%'";
    ...
    ?>
        <tr>
          ...
          <td class="table_item"><img style="width:80px" src="../../images/gallery/<?php echo $row['image']; ?>" alt=""></td>
    ...
    <?php } else { ?>
      ...
      <tr>
        <td colspan="6">No record found.<a href="<?php echo $_SERVER['PHP_SELF']; ?>">Vui lòng thử lại</a>.</td>
      </tr>
